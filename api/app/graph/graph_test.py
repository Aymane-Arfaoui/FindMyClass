from api.app.graph.Graph import *
...
if __name__ == "__main__":
    ...
    graph = load_graph_from_json(None,"/Users/evanteboul/SOEN390/FindMyClass/api/app/data/map_hall_2.json",
    ...
    top_paths = graph.yen_k_shortest_paths(graph, start_node, end_node, K=3)
